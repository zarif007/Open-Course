...
import AnimatedBeam from '../ui/animation/AnimatedBeam';
...
function LandingPageFigureBeam({ className }: { className?: string }) {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex flex-row items-stretch justify-between gap-24 sm:gap-36 md:gap-44 lg:gap-64">
        ...
        <div className="flex flex-col justify-center">
          <Circle
            ref={div7Ref}
            className="w-12 h-12 sm:w-14 sm:h-14 md:w-18 md:h-18 lg:w-20 lg:h-20"
          >
            <Icons.user />
          </Circle>
        </div>
...
export default LandingPageFigureBeam;
